    ...
    <div class="mx-auto max-w-4xl py-12 px-8">
        ...
        <div class="shadow-md sm:rounded-lg">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="relative z-0 w-full mb-6 group">
                            <textarea name="prdDescripcion" id="prdDescripcion" rows="2" class="resize-none block py-2.5 px-0 w-full text-2xl bg-transparent border-0 border-b-2 appearance-none text-teal-400 border-gray-600 focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" "
